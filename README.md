# gframeAE
A Java 3D engine for Android applications. Uses its own software renderer instead of an OpenGL implementation for broader availability. For sources have a look at the standard [gframe repository](https://github.com/conradplake/gframe).
